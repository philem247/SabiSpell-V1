 ...
 */
export function speak(text: string, language: 'en' | 'yo' = 'en', rate: number = 0.85): void {
  ...
  Speech.speak(text, {
    ...
    onError: () => {
      ...
      Speech.speak(text, { language: 'en', rate });
    },
  });
}
 ...
 */
export function speakSlowly(text: string, language: 'en' | 'yo' = 'en'): void {
